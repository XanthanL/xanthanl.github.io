...
export const SECTORS: Sector[] = [
  ...
  },
  {
    ...
    index: '04',
    label: 'NDW_04',
    name: 'NeonDAW 浏览器音频工作站',
    desc: '浏览器内运行的完整 DAW（数字音频工作站）。鼓机步进音序、钢琴卷帘、带效果链的调音台、整曲编排，并能离线导出真正的 WAV 文件。无安装、无账号、无后端：鼓与合成器由 Web Audio API 实时生成，旋律乐器用内置真实采样；React + TypeScript + Tone.js 全前端，中英双语。',
    tags: ['DAW', 'WEB AUDIO', 'TONE.JS'],
    color: '#ff2d95',
    url: 'https://xanthanl.github.io/neon-daw/',
    repo: 'https://github.com/XanthanL/neon-daw',
    dist: 15,
    speed: 0.2,
    size: 0.5,
    kind: 'torusKnot',
