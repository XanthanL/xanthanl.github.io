...
export const SECTORS: Sector[] = [
  ...
  },
  {
    ...
    color: '#ff6ec7',
    url: 'https://www.xanthanl.cc.cd/picmark-studio/',
  ...
  },
  {
    ...
    tags: ['旅行', '时间线', '地图'],
    color: '#38bdf8',
    url: 'https://www.xanthanl.cc.cd/shuyan-travel/',
  ...
  },
  {
    ...
    color: '#8b00ff',
    url: 'https://www.xanthanl.cc.cd/XanthanLMusic/',
  ...
  },
  {
    ...
    tags: ['测试', '六维坐标', 'REACT'],
    color: '#c8d8ff',
    url: 'https://www.xanthanl.cc.cd/ARH',
  ...
  },
  {
    ...
    tags: ['游戏', '多引擎', '实验场'],
    color: '#ff4a1c',
    url: 'https://www.xanthanl.cc.cd/game-lab/',
